...
- [**Suport de KaTeX**](@/blog/markdown.ge.md#katex). Habilitat configurant `katex = true` (274 KB).
- [**Còpia de blocs de codi amb un sol clic**](@/blog/markdown.ge.md#bloc-de-codi). Habilitada configurant `copy_button = true`. (~700 bytes)
- [**Enllaços de retorn per a notes a peu de pàgina**](@/blog/markdown.ge.md#1). Habilitats configurant `footnote_backlinks = true` (~500 bytes).
