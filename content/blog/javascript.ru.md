...
- [**Soporte de KaTeX**](@/blog/markdown.ru.md#katex). Habilitado al configurar `katex = true` (274 KB).
- [**Copia de bloques de código con un solo clic**](@/blog/markdown.ru.md#bloque-de-codigo). Habilitado al configurar `copy_button = true` (~700 bytes).
- [**Enlaces de retorno de notas al pie**](@/blog/markdown.ru.md#1). Habilitado al configurar `footnote_backlinks = true` (~500 bytes).
